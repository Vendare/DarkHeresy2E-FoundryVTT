export class DarkHeresyActor extends Actor {
  ...
  _computePower() {
      ...
      for (let item of this.items) {
          if (item.isStarshipCore) { this.system.powerUsed += parseInt(item.powerUse, 0); }
          if (item.isStarshipSupplementary) { this.system.powerUsed += parseInt(item.powerUse, 0); }
          if (item.isStarshipWeapon) { this.system.powerUsed += parseInt(item.powerUse, 0); }
  ...
  _computeSpace() {
      ...
      for (let item of this.items) {
          if (item.isStarshipCore) { this.system.spaceUsed += parseInt(item.spaceUse, 0); }
          if (item.isStarshipSupplementary) { this.system.spaceUsed += parseInt(item.spaceUse, 0); }
          if (item.isStarshipWeapon) { this.system.spaceUsed += parseInt(item.spaceUse, 0); }
      }
  }
  ...
  _computeSquadrons() {
      ...
      for (let item of this.items) {
          if (item.isSquadrons) { this.system.squadCount += parseInt(item.squadcount, 0); }
      }
  }
